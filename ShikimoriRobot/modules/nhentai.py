...
from ShikimoriRobot import pgram, telegraph
from ShikimoriRobot.utils.errors import capture_err


@pgram.on_message(~filters.me & filters.command('hentai', prefixes='/'), group=8)
@capture_err
...
def nhentai_data(noombers):
    ...
    post = telegraph.create_page(
        ...
        author_name="@Shikimori_Robot", 
        author_url="https://t.me/Shikimori_Robot"
    )
