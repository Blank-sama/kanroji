...
SUDOLIST_HANDLER = CommandHandler(["sudolist", "kinoes"], sudolist, run_async=True)
DEVLIST_HANDLER = CommandHandler(["devlist", "hashiras"], devlist, run_async=True)
